...
본 디렉토리는 학습한 내용이나 성장하는 과정에서 경험한 시행착오들을 기록해 놓은 공간입니다.  

꾸준히 성장하기 위해 한 번 기록하고 끝나는 방식의 학습이 아닌  
성장 과정에서 얻은 경험을 바탕으로 이전의 기록을 퇴고해 보면서 새로운 깨달음을 얻고 견문이 넓어지는 학습을 지향합니다.  
  
따라서 기록된 내용은 항상 미완이며 언제든지 수정, 변경될 수 있습니다.

README 형식은 [namjunemy](https://github.com/namjunemy)님의 Github TIL를 참조하였습니다.
...
- [커넥션 풀 이해](https://github.com/seokmyungham/TIL/blob/main/SpringDB/datasource_01.md)
- [커넥션 풀과 데이터 소스](https://github.com/seokmyungham/TIL/blob/main/SpringDB/datasource_02.md)
- [트랜잭션 이해](https://github.com/seokmyungham/TIL/blob/main/SpringDB/transaction_01.md)
- [트랜잭션 매니저와 템플릿](https://github.com/seokmyungham/TIL/blob/main/SpringDB/transaction_02.md)
- [자바 예외 이해](https://github.com/seokmyungham/TIL/blob/main/SpringDB/java_exception.md)
- [스프링 예외 처리](https://github.com/seokmyungham/TIL/blob/main/SpringDB/spring_exception.md)
- [스프링 JdbcTemplate](https://github.com/seokmyungham/TIL/blob/main/SpringDB/jdbctemplate.md)
- [MyBatis 이해](https://github.com/seokmyungham/TIL/blob/main/SpringDB/mybatis.md)
...
- [기본 키 매핑 방법](https://github.com/seokmyungham/TIL/blob/main/JPA/entity_mapping_02.md)
- [단방향, 양방향 매핑](https://github.com/seokmyungham/TIL/blob/main/JPA/association_mapping_01.md)
- [다대일, 일대다, 일대일, 다대다 매핑](https://github.com/seokmyungham/TIL/blob/main/JPA/association_mapping_02.md)
- [고급 매핑](https://github.com/seokmyungham/TIL/blob/main/JPA/advanced_mapping.md)
- [프록시](https://github.com/seokmyungham/TIL/blob/main/JPA/proxy.md)
- [즉시 로딩, 지연 로딩](https://github.com/seokmyungham/TIL/blob/main/JPA/eager_lazy_loading.md)
- [값 타입, 불변 객체](https://github.com/seokmyungham/TIL/blob/main/JPA/value_type.md)
- [변경 감지와 병합](https://github.com/seokmyungham/TIL/blob/main/JPA/dirtychecking_and_merge.md)
- [페치 조인 개념](https://github.com/seokmyungham/TIL/blob/main/JPA/fetch_join_01.md)

### API
- [API 개발 시 DTO를 사용해야 하는 이유](https://github.com/seokmyungham/TIL/blob/main/API/dto.md)
- [xToOne 성능 최적화 - Fetch Join, Dto를 직접 조회](https://github.com/seokmyungham/TIL/blob/main/API/to_one_tuning.md)
- [OneToMany 성능 최적화 - batch_fetch_size](https://github.com/seokmyungham/TIL/blob/main/API/to_many_tuning_01.md)
- [OSIV](https://github.com/seokmyungham/TIL/blob/main/API/osiv.md)

### SpringBatch
- [스프링 배치란?](https://github.com/seokmyungham/TIL/blob/main/SpringBatch/springbatch_01.md)
- [Spring Batch Domain & MetaData](https://github.com/seokmyungham/TIL/blob/main/SpringBatch/batch_domain_01.md)
